...
# Expected output: 593971626975.dkr.ecr.us-east-1.amazonaws.com/pagerduty-lite-dev-api
```
...
aws ecr get-login-password --region us-east-1 | \
  ...
  593971626975.dkr.ecr.us-east-1.amazonaws.com
```
...
```bash
# From project root
ECR_URL="593971626975.dkr.ecr.us-east-1.amazonaws.com/pagerduty-lite-dev-api"
