...
export class MigrationAnalyzer {
  ...
  async analyzeRecentMigrations(sinceHours: number = 24): Promise<MigrationRisk[]> {
    ...
    try {
      ...
      logger.info('MigrationAnalyzer: Analyzing recent migrations', {
      ...
      logger.info('MigrationAnalyzer: Analysis complete', {
      ...
      logger.error('MigrationAnalyzer: Failed to analyze migrations', { error });
  ...
  async analyzeMigrationFile(fileName: string): Promise<MigrationRisk[]> {
    ...
    try {
      ...
      logger.error('MigrationAnalyzer: Failed to analyze migration file', { fileName, error });
