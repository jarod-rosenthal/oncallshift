    ...
    <div className="relative">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white/[0.03] border-2 border-white/5 rounded-2xl p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-teal-500/5 border-l-4 border-teal-500 p-6 my-8">
                <p className="font-semibold text-teal-300 mb-3">What 15 years of on-call taught us:</p>
                <ul className="space-y-2 text-teal-400/80">
              ...
              <p className="text-slate-300 mb-6">
                We're still a small team. We still get paged. <strong className="text-white">We run OnCallShift on OnCallShift.</strong>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-8">
              <div className="flex flex-col md:flex-row items-start gap-6">
                <div className="w-24 h-24 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-full flex items-center justify-center text-slate-950 text-3xl font-bold flex-shrink-0">
                  JR
                </div>
                <div className="flex-1">
                  <h3 className="text-2xl font-bold mb-2 text-white">Jarod Rosenthal</h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="bg-white/[0.05] text-slate-300 px-3 py-1 rounded-full text-sm">AWS</span>
                    <span className="bg-white/[0.05] text-slate-300 px-3 py-1 rounded-full text-sm">Kubernetes</span>
                    <span className="bg-white/[0.05] text-slate-300 px-3 py-1 rounded-full text-sm">Terraform</span>
                    <span className="bg-white/[0.05] text-slate-300 px-3 py-1 rounded-full text-sm">SRE</span>
                    <span className="bg-white/[0.05] text-slate-300 px-3 py-1 rounded-full text-sm">Platform Engineering</span>
                  </div>
                  <a
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-white">How We Work</h2>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-white">1. Eat Our Own Dog Food</h3>
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-white">3. Developer Experience First</h3>
              <p className="text-slate-400">
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-white">4. Privacy Matters</h3>
              <p className="text-slate-400">
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-white">5. Build for Practitioners</h3>
              <p className="text-slate-400">
            ...
            <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
              <h3 className="text-xl font-bold mb-3 text-white">6. Ship Fast, Learn Faster</h3>
              <p className="text-slate-400">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="mailto:jarod@oncallshift.com">
              <Button size="lg" variant="outline" className="border-slate-950 text-slate-950 hover:bg-slate-950/10">
                Email Us
              </Button>
            </a>
          </div>
