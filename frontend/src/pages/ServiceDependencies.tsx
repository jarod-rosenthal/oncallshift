...
export function ServiceDependencies() {
  ...
  if (loading) {
    return (
      <div className="p-6">
        <div className="text-center py-12 text-gray-500">Loading dependency graph...</div>
      </div>
    );
  }
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-200 rounded-lg">
            <div className="p-4 border-b border-gray-200">
              ...
              <p className="text-xs text-gray-500 mt-1">Click to view dependencies</p>
            </div>
            <div className="max-h-[600px] overflow-y-auto">
              {graph?.nodes.length === 0 ? (
                <div className="p-4 text-gray-500 text-sm text-center">No services found</div>
              ) : (
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            {node.businessServiceName && (
                              <p className="text-xs text-gray-500">{node.businessServiceName}</p>
                            )}
                          </div>
        ...
        <div className="lg:col-span-2">
          {selectedService && serviceDeps ? (
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg">
                ...
                {serviceDeps.upstream.length === 0 ? (
                  <div className="p-4 text-gray-500 text-sm">No upstream dependencies</div>
                ) : (
                  <div className="divide-y divide-gray-100">
              ...
              <div className="bg-white border border-gray-200 rounded-lg">
                ...
                {serviceDeps.downstream.length === 0 ? (
                  <div className="p-4 text-gray-500 text-sm">No downstream dependents</div>
                ) : (
                  <div className="divide-y divide-gray-100">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-500">Select a service to view its dependencies</p>
          ...
          {graph && graph.edges.length > 0 && !selectedService && (
            <div className="mt-6 bg-white border border-gray-200 rounded-lg p-4">
              <h3 className="font-semibold text-gray-900 mb-4">Dependency Overview</h3>
            ...
            <form onSubmit={handleAddDependency}>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-center">
                  ...
                  <span className="ml-2 text-sm text-gray-500">depends on</span>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mb-2">The service being depended upon</p>
                  <select
