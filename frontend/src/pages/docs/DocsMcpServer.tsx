  ...
  "mcpServers": [
    {
      ...
      "env": {
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-lg space-y-4 my-4">
          <div className="flex gap-3">
            <span className="font-medium text-blue-600 dark:text-blue-400">You:</span>
            <span>I want to migrate from PagerDuty to OnCallShift</span>
          </div>
          <div className="flex gap-3">
            <span className="font-medium text-green-600 dark:text-green-400">AI:</span>
            <span>I can help with that! First, I need your PagerDuty API key. You can create a read-only key at User Settings → API Access.</span>
          </div>
          <div className="flex gap-3">
            <span className="font-medium text-blue-600 dark:text-blue-400">You:</span>
            <span>Here's my key: pdkey_xxx</span>
          </div>
          <div className="flex gap-3">
            <span className="font-medium text-green-600 dark:text-green-400">AI:</span>
            <span>Connected! Found 15 users, 4 teams, 3 schedules, 12 services. Want me to preview what will be migrated?</span>
          </div>
          <div className="flex gap-3">
            <span className="font-medium text-blue-600 dark:text-blue-400">You:</span>
            <span>Yes, then migrate everything</span>
          </div>
          <div className="flex gap-3">
            <span className="font-medium text-green-600 dark:text-green-400">AI:</span>
            <span>Migration complete! All users have been invited, schedules configured, and services created. Integration keys have been preserved for zero-downtime transition.</span>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              <tr><td className="py-2 pr-4 font-mono text-xs">get_oncall_now</td><td>Get currently on-call users</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">list_incidents</td><td>List incidents with filters</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">acknowledge_incident</td><td>Acknowledge an incident</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">resolve_incident</td><td>Resolve an incident</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">escalate_incident</td><td>Escalate to next level</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">list_services</td><td>List all services</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">list_teams</td><td>List all teams</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">list_schedules</td><td>List on-call schedules</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">get_incident_metrics</td><td>Get MTTR, MTTA, trends</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">analyze_oncall_fairness</td><td>Analyze on-call load distribution</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">suggest_improvements</td><td>AI-powered improvement suggestions</td></tr>
              <tr><td className="py-2 pr-4 font-mono text-xs">migrate_from_mcp</td><td>Migrate from PagerDuty/Opsgenie</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <ul className="list-disc ml-6 space-y-1">
          <li>Verify your API key is valid at <Link to="/settings/api-keys" className="text-blue-600 hover:underline">Settings → API Keys</Link></li>
