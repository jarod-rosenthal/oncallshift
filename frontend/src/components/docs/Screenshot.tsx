...
export function VideoEmbed({ src, title, caption }: VideoEmbedProps) {
  ...
  return (
    <figure className="my-6">
      <div className="rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm aspect-video bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
